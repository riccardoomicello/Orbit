...
const navLinks = [
  ...
  { to: '/routine', label: 'Routine', icon: <IconRoutine />, end: false },
  { to: '/finanza', label: 'Finanza', icon: <IconWallet />, end: false },
  { to: '/extra', label: 'Extra', icon: <IconExtra />, end: false },
]
    ...
    <div className="app-shell">
      <header className="header">
        ...
        <div className="header-actions">
          ...
          <button onClick={signOut} className="icon-btn" aria-label="Esci">
            <IconLogout />
          </button>
        </div>
      </header>
